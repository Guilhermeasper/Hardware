//tive q começar do zero pq o pc travou na linha 77 sem eu ter salvo ;))))))))
module controle(
    input clock,
    input igual,
    input menor,
    ...
    if(reset)begin
        ...
        case(estadoOverflow)
            ...
            2'b1: begin//overflow 2
                ...
                hilo=1'b0;
                ir_write=1'b0;
                mdr_write=1'b1;//escreve oq tá em 253 em mdr e extende o sinal
                ls_control=1'b0;
                shamt=1'b0;
                shift_sorce=1'b0;
                shift_control=1'b0;
                ...
                ALUSourceB=3'b0;
                ALUControl=3'b0;//dá hold em mdr extendido
                ALUOut=1'b0;
                epc=1'b0;
            ...
            2'b11: begin//overflow 4
                pc_write=1b'0;//esse estado só serve pra fechar o pc_write
                mux_mem=2'b0;
                mux_to_mux_mem=2'b0;
                mem_write=1'b0;
                ss_control=1'b0;
        ...
        case(estado) begin
            8'b0: begin//fetch 1
                ...
                mult_div=2'b0;
                hilo=1'b0;
                ir_write=1'b1;//escreve a instrução em ir_write
                mdr_write=1'b0;
                ls_control=1'b0;
                shamt=1'b0;
                shift_sorce=1'b0;
