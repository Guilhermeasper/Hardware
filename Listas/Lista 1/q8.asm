...
# Entrada
A: .word 6 # entrada para fib
X: .word 20 # Espaço alocado an memória
...
beq $t0, $s1, returnOne # verifica se e verdadeiro e pula para retornar 1
